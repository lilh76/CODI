...
def main(Config, RUN):
    ...
    Config.use_label_model = getattr(Config, "use_label_model", True)
    Config.label_model_path = getattr(Config, "label_model_path", True)
    ...
    diffusion_config = utils.Config(
        ...
        share_fwd=Config.share_fwd,
        joint_fwd=Config.joint_fwd,
        # loss weighting
        ...
        use_inv_dyn=Config.use_inv_dyn,
        use_fwd_dyn=Config.use_fwd_dyn,
        use_rwd_model=Config.use_rwd_model,
        use_legal_model=Config.use_legal_model,
        use_label_model=Config.use_label_model,
