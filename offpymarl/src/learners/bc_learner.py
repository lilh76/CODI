...
class BCLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        loss = F.cross_entropy(mac_out.reshape(-1, ac_dim), actions.squeeze(-1).reshape(-1), reduction="none")
        loss = loss.reshape(bs, t, n_agents)
        mask = mask.expand(-1, -1, n_agents) # [bs, t, n_agents]
