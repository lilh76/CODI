...
from data_aug import run as data_aug
...
if __name__ == '__main__':
    ...
    unique_token = "seed_{}_{}_{}".format(config_dict['seed'], Y_M_D, H_M_S)
    ...
    match config_dict['run_file']:
        ...
        case 'data_aug':
            ...
            results_save_dir = os.path.join(
                results_path, "data_aug", Y_M_D, env, map_name,
                config_dict['offline_data_quality'],
                config_dict['name'] + config_dict['remark'],
                unique_token
            )
